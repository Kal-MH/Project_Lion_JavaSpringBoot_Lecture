...
import dev.kalmh.websocket.model.ChatMessage;
...
public class WebSocketMapping {
    ...
    public WebSocketMapping(SimpMessagingTemplate simpMessagingTemplate) { this.simpMessagingTemplate = simpMessagingTemplate;}
    ...
    public void sendChatALL(ChatMessage chatMessage) {
