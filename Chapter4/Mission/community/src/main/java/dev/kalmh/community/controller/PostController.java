...
import dev.kalmh.community.repository.PostRepository;
...
public class PostController {
    ...
    public ResponseEntity<PostDto> createPost(
        ...
        return ResponseEntity.ok(result.passswordMasked());
    ...
    public ResponseEntity<PostDto> readPost(
        ...
        else return ResponseEntity.ok(postDto.passswordMasked());
    }
